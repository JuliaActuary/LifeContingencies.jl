...
@testset "one  year" begin
    ...
    @test present_value(AnnuityImmediate(ins, n = 1)) ≈ 1 * 0.5 / 1.05
    ...
    @test present_value(AnnuityImmediate(ins_jl, n = 1)) ≈ 1 * 0.75 / 1.05
    @test present_value(AnnuityDue(ins_jl, n = 2)) ≈ 1 + 1 * 0.75 / 1.05
...
@testset "two year with interest" begin
    ...
    @test present_value(AnnuityDue(ins, n = 1)) ≈ 1
    @test present_value(AnnuityDue(ins, n = 2)) ≈ 1 + 1 * 0.5 * 1 / 1.05
    @test present_value(AnnuityDue(ins, n = 3)) ≈ 1 + 1 * 0.5 * 1 / 1.05 + 1 * 0.25 / 1.05^2
    @test present_value(AnnuityDue(ins, n = 0)) ≈ 0
    @test present_value(AnnuityImmediate(ins, n = 0)) ≈ 0
    @test present_value(AnnuityImmediate(ins, n = 1)) ≈ 1 * 0.5 * 1 / 1.05
...
@testset "two years" begin
    ...
    @test present_value(AnnuityDue(ins, n = 1)) ≈ 1
    @test present_value(AnnuityDue(ins, n = 2)) ≈ 1 + 1 * 0.5 * 1 / 1.05
    @test present_value(AnnuityDue(ins, n = 3)) ≈ 1 + 1 * 0.5 * 1 / 1.05 + 1 * 0.25 * 1 / 1.05^2
    @test present_value(AnnuityDue(ins, n = 0)) == 0
    @test present_value(AnnuityImmediate(ins, n = 0)) == 0
    @test present_value(AnnuityImmediate(ins, n = 1)) ≈ 1 * 0.5 * 1 / 1.05
    ...
    @test present_value(AnnuityDue(ins_jl, n = 1)) ≈ 1
    @test present_value(AnnuityDue(ins_jl, n = 2)) ≈ 1 + 1 * 0.75 / 1.05
    @test present_value(AnnuityDue(ins_jl, n = 3)) ≈ 1 + 1 * 0.75 / 1.05 + 1 * survival(ins_jl, 2) / 1.05^2
    @test present_value(AnnuityDue(ins_jl, n = 0)) == 0
