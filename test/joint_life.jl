@testset "Joint Life" begin
    ...
    @testset "Joint Last Survivor unknown status" begin
        ...
        @testset "ASM Manual 13th Ed., Example 54B" begin
            q1 = UltimateMortality([0.10, 0.12, 0.14, 0.16, 0.18], start_age=80)
            q2 = UltimateMortality([0.07, 0.09, 0.11, 0.13, 0.15], start_age=80)
        ...
        @testset "ALMCR §9.4" begin
            ...
            ins = LifeContingency(jl, 0.05)
            ins_l1 = LifeContingency(jl.lives[1], 0.05)
            ins_l2 = LifeContingency(jl.lives[2], 0.05)
            # problem 9.1.f
